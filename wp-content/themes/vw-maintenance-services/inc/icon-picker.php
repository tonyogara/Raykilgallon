...
class VW_Maintenance_Services_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $vw_maintenance_services_font_awesome_icon_array = vw_maintenance_services_font_awesome_icon_array();
                    foreach ($vw_maintenance_services_font_awesome_icon_array as $vw_maintenance_services_font_awesome_icon) {
                            $icon_class = $this->value() == $vw_maintenance_services_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($vw_maintenance_services_font_awesome_icon).'"></i>
                            <span class="vw-maintenance-services-social-class">'.esc_attr($vw_maintenance_services_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function vw_maintenance_services_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', get_template_directory_uri().'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'vw-maintenance-services-customizer-script', get_template_directory_uri().'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'vw_maintenance_services_customizer_script' );

if(!function_exists('vw_maintenance_services_font_awesome_icon_array')){
    function vw_maintenance_services_font_awesome_icon_array(){
