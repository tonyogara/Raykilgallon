...
<article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
  <div class="post-main-box ">
    <?php $vw_maintenance_services_theme_lay = get_theme_mod( 'vw_maintenance_services_blog_layout_option','Default');
    ...
    <?php }else if($vw_maintenance_services_theme_lay == 'Left'){ ?>
      <div class="service-text">
        <div class="box-image">
          <?php the_post_thumbnail(); ?>
        </div>
